...
public class HttpAdminAuthenticationConfig extends HttpAuthenticationConfig
{
    ...
    @Inject
    public HttpAdminAuthenticationConfig(final UserRepository userRepository, final UserTokenRepository userTokenRepository)
    {
